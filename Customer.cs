...
namespace Outfit
{
    public partial class Customer : Form
    {
        ...
        SqlConnection Con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\chand\OneDrive\Documents\Rentaldb.mdf;Integrated Security=True;Connect Timeout=30");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    cmd.ExecuteNonQuery();
                    MessageBox.Show("Successfully Added the Customer");
                    Con.Close();
                    populate();
                }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand(query, Con);
                    cmd.ExecuteNonQuery();
                    MessageBox.Show("Successfully deleted the Customer");
                    Con.Close();
                    populate();
                }
                catch (Exception Myex)
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    string query = "update CustomerTbl set CustName='" + NameTb.Text + "',CustAdd='" + AddressTb.Text + "', CustPhone='" + PhoneTb.Text + "' where CustId=" + IdTb.Text + ";";
                    SqlCommand cmd = new SqlCommand(query, Con);
                    cmd.ExecuteNonQuery();
                    MessageBox.Show("Successfully Updated the Customer");
                    Con.Close();
                    populate();
                }
                catch (Exception Myex)
